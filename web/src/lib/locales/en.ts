export default {
  ...
  'dialog.restart.description': 'Restart "{name}": the current process is stopped and respawned in place with history preserved. Use this after changing model API keys or configuration.',
  'dialog.restart.confirm': 'Restart',
  'dialog.restart.confirming': 'Restarting…',
  'dialog.restart.errorTitle': 'Could not restart session',
  ...
  'settings.usage.speed.median': 'Median {value} tok/s',
  'settings.usage.speed.p90': 'P90 {value} tok/s',
  'settings.usage.speed.samples': '{count} samples',
